...
#         chat_id=user_id,
#         text=texts.PREPARING_TAKE[lang]
#     )
#
#     await call.message.edit_text(
#         text=old_message_text,
#         reply_markup=buttons.TAKE_READY_BUTTON(user_id)
#     )
#
#
# @dp.callback_query_handler(lambda callbask_query: callbask_query.data.startswith("t_preparing:"))
